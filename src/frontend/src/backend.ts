...
export class Backend implements backendInterface {
    ...
    async getRequest(arg0: bigint): Promise<ConsultationRequest> {
        if (this.processError) {
            try {
    ...
    async getRequestsByServiceInterest(arg0: string): Promise<Array<ConsultationRequest>> {
        if (this.processError) {
            try {
                const result = await this.actor.getRequestsByServiceInterest(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
